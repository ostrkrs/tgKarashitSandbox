/datum/job/chief_engineer
	...
	family_heirlooms = list(/obj/item/clothing/head/utility/hardhat/white, /obj/item/screwdriver, /obj/item/wrench, /obj/item/weldingtool/fueled, /obj/item/crowbar, /obj/item/wirecutters)
