...
#define COMSIG_KB_LIVING_TOGGLEMOVEINTENT_UP "keybinding_mob_togglemoveintent_up"
#define COMSIG_KB_LIVING_TOGGLEMOVEINTENTALT_UP "keybinding_mob_togglemoveintentalt_up"
